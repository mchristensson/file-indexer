...
public class ScaleFunction implements Function<BufferedImage, BufferedImage> {
    ...
    public BufferedImage apply(BufferedImage image) {
        ...
        int h1 = 1;
        int w1 = 1;
        logger.debug("Original Size [width={}, height={}, type={}, grayscale={}]", w0, h0, image.getType(), grayscale);
        if (h0 >= w0) {
        ...
        BufferedImage scaled = new BufferedImage(w1, h1, grayscale ? BufferedImage.TYPE_BYTE_GRAY : image.getType());
